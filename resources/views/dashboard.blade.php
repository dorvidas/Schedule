                    ...
                    <form action="{{ route('dashboard') }}" method="post">
                        ...
                        <div class="modal-content py-4 text-left px-6">
                            ...
                            <div class="flex justify-end pt-2">
                                <button type="submit"
                                        class="modal-close px-4 bg-transparent p-3 rounded-lg text-purple-800 hover:bg-gray-100 hover:text-purple-400 mr-2">
                                    Save
                                </button>
                                <button type="button"
                                        class="modal-close px-4 bg-purple-800 p-3 rounded-lg text-white hover:bg-purple-400">
                                    Close
                                </button>
                            </div>
                        </div>
